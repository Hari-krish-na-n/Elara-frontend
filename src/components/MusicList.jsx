...
function MusicList({ songs = [], playSong, currentSongId, playlists = [], addSongToPlaylist, searchQuery = '', onOpenPlaylistSidebar, isSongLiked, onToggleLike, onAddToQueue, focusTarget }) {
